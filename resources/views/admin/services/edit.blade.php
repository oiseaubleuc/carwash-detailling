...
<div style="width: 100%; max-width: 800px;">
    <h1 style="color: #E8D5B7; font-size: 2.5rem; margin-bottom: 20px;">Dienst Bewerken</h1>
    ...
    <form action="{{ route('admin.services.update', $service->id) }}" method="POST" style="background-color: #111111; padding: 30px; border-radius: 8px; border: 1px solid rgba(232, 213, 183, 0.3);">
        @csrf
        @method('PUT')
        ...
        <div style="margin-bottom: 20px;">
            ...
            <textarea name="description" id="description" rows="4"
                      style="width: 100%; padding: 10px; border: 1px solid rgba(232, 213, 183, 0.3); border-radius: 5px; background-color: #000000; color: #e8e8e8;">{{ old('description', $service->description) }}</textarea>
        </div>
