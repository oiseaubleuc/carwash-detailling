...
<div style="width: 100%; max-width: 800px;">
    <h1 style="color: #E8D5B7; font-size: 2.5rem; margin-bottom: 20px;">Gebruiker Bewerken</h1>
    ...
    <form action="{{ route('admin.users.update', $user->id) }}" method="POST" style="background-color: #111111; padding: 30px; border-radius: 8px; border: 1px solid rgba(232, 213, 183, 0.3);">
        @csrf
        @method('PUT')
        ...
        <div style="margin-bottom: 20px;">
            <label for="password" style="display: block; color: #E8D5B7; font-weight: 500; margin-bottom: 5px;">Wachtwoord (laat leeg om niet te wijzigen)</label>
